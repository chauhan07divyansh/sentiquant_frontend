...
const colorMap = {
  ...
  indigo:  'bg-[rgba(6,100,232,0.08)] border-[rgba(6,100,232,0.15)] text-brand-blue',
  success: 'bg-[rgba(16,185,129,0.08)] border-[rgba(16,185,129,0.2)] text-[#10b981]',
  warning: 'bg-[rgba(244,63,94,0.08)] border-[rgba(244,63,94,0.2)] text-[#f43f5e]',
  danger:  'bg-[rgba(244,63,94,0.08)] border-[rgba(244,63,94,0.2)] text-[#f43f5e]',
  neutral: 'bg-[rgba(255,255,255,0.05)] border-[rgba(255,255,255,0.08)] text-[#777a88]',
