  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M8 5v1.5M8 9.5V11M6.5 6.5C6.5 5.7 7.2 5 8 5s1.5.7 1.5 1.5S8.8 8 8 8s-1.5.7-1.5 1.5S7.2 11 8 11"/>
      </svg>
    ),
  },
  {
      ...
      {!collapsed && (
        <>
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs font-semibold text-surface-900 dark:text-white truncate leading-none">{user.name ?? user.email}</p>
...
export function Sidebar() {
  ...
  useEffect(() => {
    closeMobileSidebar()
  }, [pathname, closeMobileSidebar]) // closeMobileSidebar is stable (Zustand action)
