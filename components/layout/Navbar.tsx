      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-2">
          ...
          {isDashboard ? (
            ...
            // Skeleton that holds the space while NextAuth checks the session
            <div className="flex items-center gap-2" aria-hidden="true">
              <div className="hidden sm:block w-14 h-8 rounded-lg bg-surface-800/60 animate-pulse" />
              <div className="w-24 h-8 rounded-lg bg-surface-800/60 animate-pulse" />
            </div>
          ) : isAuthenticated ? (
            <Link href="/dashboard">
        ...
        <div className="md:hidden absolute top-full left-0 right-0 bg-surface-950/95 backdrop-blur-md border-b border-surface-800 py-3 px-4 flex flex-col gap-1 animate-fade-in">
          ...
          {isLoading ? (
            <div className="flex gap-2" aria-hidden="true">
              <div className="flex-1 h-9 rounded-lg bg-surface-800/60 animate-pulse" />
              <div className="flex-1 h-9 rounded-lg bg-surface-800/60 animate-pulse" />
            </div>
          ) : isAuthenticated ? (
            <Link href="/dashboard">
