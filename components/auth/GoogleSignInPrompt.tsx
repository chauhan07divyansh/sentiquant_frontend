...
export function GoogleSignInPrompt() {
  ...
  useEffect(() => {
    // Don't show if already logged in or dismissed this session
  ...
  return (
    <div
      className={cn(
        'fixed top-4 right-4 z-50 w-[300px]',
        'rounded-2xl border border-surface-700 bg-surface-950/95 backdrop-blur-xl shadow-2xl',
      ...
      <div className="p-4 flex flex-col gap-3">
        ...
        <div className="flex items-start justify-between gap-2">
          ...
          <button
            ...
            className="shrink-0 w-6 h-6 flex items-center justify-center rounded-lg text-surface-500 hover:text-white hover:bg-surface-800 transition-all"
            aria-label="Dismiss"
          >
        ...
        >
          {loading ? (
            <svg className="animate-spin w-4 h-4 shrink-0 text-gray-600" viewBox="0 0 24 24" fill="none">
