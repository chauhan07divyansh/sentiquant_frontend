  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
      ...
      {state === 'error' && apiError && (
        <div className="flex items-start gap-2 px-4 py-3 rounded-lg bg-rose-500/8 border border-rose-500/20 text-xs text-rose-400 leading-relaxed">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" className="shrink-0 mt-0.5">
