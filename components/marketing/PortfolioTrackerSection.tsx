  ...
  return (
    ...
    >
      ...
      {pos.currentPrice == null ? (
        <>
          {/* Entry price — always visible even without live price */}
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px', marginTop: '6px' }}>
            ...
            <span style={{ fontFamily: 'var(--font-inter), Inter, system-ui, sans-serif', fontSize: '12px', color: '#acafb9' }}>
              T1 <span style={{ color: '#0664e8' }}>₹{pos.t1.toLocaleString('en-IN')}</span>
              {' · '}
              T2 <span style={{ color: '#0664e8' }}>₹{pos.t2.toLocaleString('en-IN')}</span>
              {' · '}
              T3 <span style={{ color: '#0664e8' }}>₹{pos.t3.toLocaleString('en-IN')}</span>
            </span>
          </div>
          ...
          >
            <svg width="10" height="10" viewBox="0 0 10 10" fill="none" aria-hidden="true">
              <circle cx="5" cy="5" r="4.5" stroke="#9194a1" strokeWidth="1" />
              <line x1="5" y1="2.5" x2="5" y2="5.5" stroke="#9194a1" strokeWidth="1.2" strokeLinecap="round" />
              <circle cx="5" cy="7.2" r="0.6" fill="#9194a1" />
            </svg>
            Price unavailable
          </span>
        </>
...
function TrackerGroup({
  ...
  const allUnavailable =
    !loading &&
    positions.length > 0 &&
    positions.every((p) => p.priceSource === 'unavailable')
