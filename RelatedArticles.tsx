...
export function GoogleSignInPrompt() {
  ...
  useEffect(() => {
    ...
    const delay = pathname?.startsWith('/stocks/') ? 4000 : 1500
  ...
  if (isAuthPage || status === 'authenticated' || dismissed || !visible) return null
  ...
  return (
    <div
      className={cn(
        'fixed bottom-4 left-4 right-4 sm:left-auto sm:right-4 sm:w-[340px] z-50',
      ...
      <div className="p-5 flex flex-col gap-4">
        ...
        <div className="flex items-start justify-between gap-2">
          ...
          <button
            ...
            className="shrink-0 w-11 h-11 flex items-center justify-center rounded-lg text-surface-500 hover:text-white hover:bg-surface-800 transition-all"
            aria-label="Dismiss"
          >
        ...
        <a
          href="/login"
          className="text-center text-xs text-surface-500 hover:text-brand-cyan transition-colors block"
