    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-4">
        <p className="text-xs text-surface-400 leading-relaxed">
          <span className="font-semibold text-amber-400">Important:</span> All outputs are AI-generated technical observations based on publicly available data. Not a research report under SEBI RA Regulations 2014. Not investment advice. Always do your own research.
        </p>
      </div>
    </div>
  )
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <button type="button" onClick={() => setType('swing')}
                      ...
                      <div className={cn('w-10 h-10 rounded-xl flex items-center justify-center text-xl', type === 'swing' ? 'bg-brand-cyan/12 border border-brand-cyan/30' : 'bg-gray-100 dark:bg-surface-800/60 border border-gray-200 dark:border-surface-700')}>
                    ...
                    <div className="relative flex flex-col gap-3 p-5 rounded-xl border border-gray-200 dark:border-surface-800 bg-surface-900/30 cursor-not-allowed opacity-60 select-none">
                      {/* Coming soon badge */}
                      ...
                      <div className="w-10 h-10 rounded-xl flex items-center justify-center text-xl bg-gray-100 dark:bg-surface-800/60 border border-gray-200 dark:border-surface-700">
                        <span aria-hidden="true">📈</span>
                      </div>
                      <div>
                    ...
                    <div className="grid grid-cols-2 gap-5">
                      <div className="flex flex-col gap-1.5">
                        ...
                        <span className="text-sm font-semibold text-surface-900 dark:text-white flex items-center gap-1.5">
                          <span aria-hidden="true">⚡</span>Swing trading
                        </span>
                      </div>
                      <div className="flex flex-col gap-1.5">
