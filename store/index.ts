...
interface UIState {
  ...
  openMobileSidebar: () => void  // IMPROVED: added mobile drawer open/close state — desktop collapse behavior unchanged
  closeMobileSidebar: () => void // IMPROVED: added mobile drawer open/close state — desktop collapse behavior unchanged
}
...
export const useUIStore = create<UIState>()(
  persist(
    (set, get) => ({
      ...
      openMobileSidebar: () => set({ isMobileOpen: true }),  // IMPROVED: added mobile drawer open/close state — desktop collapse behavior unchanged
      closeMobileSidebar: () => set({ isMobileOpen: false }), // IMPROVED: added mobile drawer open/close state — desktop collapse behavior unchanged
